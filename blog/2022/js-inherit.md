...
`JS`的继承，核心就是靠**原型链**完成。如果大家对原型链还不是很清楚，可以先读读我写的这篇关于原型链的文章——[`__proto__`、`prototype`、`constructor`、原型链，真没那么难！教你怎么套用方法直接判断](https://limingcan562.github.io/posts/about-prototype)。 
